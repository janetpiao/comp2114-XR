...
const createScene = async function() {
    ...
    // Function to create a a random shape with random size and colour
    function buildRandomShape() {
        const size = Math.random() * 0.25 + 0.15;

        // Random shape type (box, sphere, cylinder, torus)
